...
@Slf4j
public class SalvarContatoUserCase {

    private final ContatoRepository contatoRepository;

    public SalvarContatoUserCase(ContatoRepository contatoRepository) {
    ...
    private void verificaSeTelefoneValido(String telefone) {
        ...
        throw new AtributoInvalidoException("Telefone não é valido. Deve conter 8 números");
    }
